...
app = FastAPI(
    title="Kenkeputa Micro-Commerce Backend",
    description="The backend server powering the Kenkeputa Micro-Commerce App",
    version="1.0.0",
    lifespan=lifespan,
    docs_url="/v1/docs",
    redoc_url="/v1/redoc",
...
async def get_root(request: Request) -> dict:
    return JSONResponse(
        ...
        content={"URL": "", "message": "Welcome to the Kenkeputa Micro-Commerce API"},
    )


@app.get("/probe", tags=["Home"])
async def probe():
    return {"message": "I am the Kenkeputa Micro-Commerce API responding"}
